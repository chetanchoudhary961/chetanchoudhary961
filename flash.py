...
TOKEN = '7326753832:AAE4GZm5INeFxB30hdo-X958Cof47QK8PWw'
MONGO_URI = 'mongodb+srv://Bishal:Bishal@bishal.dffybpx.mongodb.net/?retryWrites=true&w=majority&appName=Bishal'
FORWARD_CHANNEL_ID = -1004515262581
CHANNEL_ID = -1004515262581
error_channel_id = -1004515262581
...
def handle_message(message):
    ...
    if message.text == "patelji Plan":
        bot.reply_to(message, '''*patelji Plan selected 👇
⬇️3 Day.   -    ..✅❌
⬇️7 Day    -   499₹✅
⬇️30 Day  -  699₹✅
...
➖➖➖➖➖➖➖➖➖➖➖➖👍*''', parse_mode='Markdown')
        ...
        bot.reply_to(message, "* <IP> <PORT> <THREADS>*", parse_mode='Markdown')
